...
namespace app\modules\ejiaoduilian\BL;
...

{
    ...
    {
        $userInfo = Yii::$app->userejiaoduilian->getIdentity()->toArray();
    ...
    static public function markRenew()
    {
        ...
        if ($toDayStatus < self::FORBIDDEN_STATUS && $toDayStatus % 10 == 0) {
            ...
            Yii::$app->userejiaoduilian->identity->$toDayStatusField = $currentStatus;
            Yii::$app->userejiaoduilian->identity->save();
        }
    ...
    static public function markPause($prize = false)
    {
        ...
        if ($prize != false && $prize['praisenumber'] > 0) {
            Yii::$app->userejiaoduilian->identity->$toDayPidField = $prize['id'];
        }
        Yii::$app->userejiaoduilian->identity->save();
