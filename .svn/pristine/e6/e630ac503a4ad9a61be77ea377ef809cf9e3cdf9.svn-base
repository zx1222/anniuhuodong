...
<div class="u-pageLoading">
    <?= Html::img('@imgUrl/images/load.gif', ['class' => '', 'alt' => '']) ?>
    ...
    <div class="wrapper">
        <div class="main-01 main-size main-bg-red">
            ...
            <div class="index main-size"
                 style="background-image: url(<?= Yii::getAlias('@imgUrl/images/home-bg.jpg') ?>);">
            </div>
            <?= Html::img('@imgUrl/images/arrow.png', ['class' => 'img-responsive center-block footer-arrow', 'alt' => '']) ?>


            <?php if (Yii::$app->userxipuhui->identity->wx_subscribe == 0): ?>
                <!-- 扫码关注 -->
                <div class="index-qr main-size">
                    <?= Html::img('@imgUrl/images/x.jpg', ['class' => 'img-responsive center-block', 'alt' => '']) ?>
                </div>
            <?php endif; ?>
        ...
        <div class="main-02 main-size main-bg-red">
            ...
            <div class="main-size award"
                 style="background-image: url(<?= Yii::getAlias('@imgUrl/images/turntable-bg.jpg') ?>);">


                <div class="turntable">
                    <div class="turntable-main">
                        <?= Html::img('@imgUrl/images/turntable-img-01.png', ['class' => 'img-responsive center-block turntable-img-01', 'alt' => '']) ?>
                        <?= Html::img('@imgUrl/images/turntable-img-02.png', ['class' => 'img-responsive center-block turntable-img-02', 'alt' => '']) ?>
                    </div>
                </div>
                ...
                <div class="partake main-size"
                     style="<?php if (!$forbidden): ?>display:none;<?php endif; ?>background-image: url(<?= Yii::getAlias('@imgUrl/images/y.png') ?>);">
                </div>
            ...
            <div class="receive main-size">
                ...
                <div class="award-main award-01"
                     style="display: none; background-image: url(<?= Yii::getAlias('@imgUrl/images/award-01-bg.jpg') ?>);">

                </div>
                <!--血压仪-->
                <div class="award-main award-02"
                     style="display: none; background-image: url(<?= Yii::getAlias('@imgUrl/images/award-02-bg.jpg') ?>);">

                </div>
                <!--拔罐器-->
                <div class="award-main award-03"
                     style="display: none; background-image: url(<?= Yii::getAlias('@imgUrl/images/award-03-bg.jpg') ?>);">

                </div>

                <!--  实物表单-->
                <div class="award-main award-form" style="display: none;">
                    ...
                    <?= Html::input('image', '', '', ['src' => Yii::getAlias('@imgUrl/images/award-btn.png'), 'class' => 'img-responsive center-block']) ?>
                ...
                <div class="award-main award-04"
                     style="display: none; background-image: url(<?= Yii::getAlias('@imgUrl/images/award-04-bg.jpg') ?>);">
            ...
            <!-- 实物奖品表单提交成功后显示-->
            <div class="endpage"
                 style="display: none; background-image: url(<?= Yii::getAlias('@imgUrl/images/endpage-bg.jpg') ?>);">
