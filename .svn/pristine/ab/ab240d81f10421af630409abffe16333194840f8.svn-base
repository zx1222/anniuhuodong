...
namespace app\modules\xipuhui\controllers;

use Yii;
use app\modules\xipuhui\BL\StatusTransfer;
use app\modules\xipuhui\models\WinForm;
use yii\web\Controller;
use yii\helpers\Url;
use app\modules\xipuhui\BL\Lottery;
