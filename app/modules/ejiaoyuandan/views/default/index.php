...
<div class="wrapper" style="display: none;">
    ...
    <div class="home page">
        ...
        <!--金蛋-->
        <div class="home-egg">
            <img src="<?= $assetsUrl; ?>/home-egg.png" alt="">
        </div>
        <!--活动规则-->
        <div class="activity-rule-detail post-a-bg" style="display: none">
            ...
            <!--关闭-->
            <img src="<?= $assetsUrl; ?>/participation-activities-close.png" alt="" class="activity-rule-detail-btn">
        </div>
    </div>
    ...
    <div class="page1 page">
        ...
        <div class="page1-title">
            <img src="<?= $assetsUrl; ?>/page1-title.png" alt="">
        </div>
        <!--砸蛋舞台-->
        <div class="page1-img">
            <img src="<?= $assetsUrl; ?>/page1-img.png" alt="">
        </div>
        <!--左右蛋-->
        <div class="egg egg-left shake">
            <img src="<?= $assetsUrl; ?>/egg.png" alt="">
        </div>
        <div class="egg egg-center shake">
            <img src="<?= $assetsUrl; ?>/egg.png" alt="">
        </div>
    ...
    <div class="page3 page">
        <!--二维码-->
        <div class="qr-code">
            <img src="<?= $assetsUrl; ?>/qr-code.png?v=201612301830" alt="">
        </div>
        <?php if ($forbidden): ?>
    ...
    <div class="page4 page">
        ...
        <div class="last-page-img">
            <img src="<?= $assetsUrl; ?>/last-page-img.png?v=201612301830" alt="">
        </div>
        <!--了解 按钮-->
        <div class="ejiao-btn">
            <img src="<?= $assetsUrl; ?>/ejiao-btn.png" alt="">
        </div>
        <!--分享 按钮-->
        <div class="share-btn">
        ...
        <!--二维码弹窗-->
        <div class="ejiao-detail post-a-bg" style="display: none">
            <!--二维码-->
            <div class="qr-code">
                <img src="<?= $assetsUrl; ?>/qr-code.png?v=201612301830" alt="">
            </div>
