        ...
        $(".wrapper").swipe(
            {
                swipe: function (event, direction, distance, duration, fingerCount) {//事件，方向，距离（像素为单位），时间，手指数量
                    ...
                    if (nowpage == 1) {
                        ...
                        setTimeout(function () {
                            $(".page2 .peach").animate({"opacity": 1}, 500);
                        ...
                        setTimeout(function () {
                            $(".page2 .peach").animate({"opacity": 0}, 100);
                            ...
                            $(".page2 .sweat").animate({"opacity": 1}, 500);

                        }, 5700)
                        setTimeout(function () {
                            $(".page2 .notext").hide();
                            $(".page2 .sweat").hide();
                            $(".page2 .page-img").animate({"opacity": 1}, 500);

                            $(".page2 .prot").animate({width: "100%"}, 8000);
