...
//         本日已经获奖:可抽但不会中奖 当天抽奖次数大于3次可抽奖不会中奖
            ...
            } elseif (StatusTransfer::getToDayPid() == 0) {
                // 可以正常抽奖
                $result = Lottery::run();
            }
            ...
            $prize['praisecontent'] = ($result['id'] != Lottery::BAD_ID) ? $result['praisecontent'] : '';
